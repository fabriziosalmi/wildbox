...
<div className="row">
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__footer">
        <a href="/docs/getting-started/quickstart" className="button button--primary button--block">Quick Start Guide</a>
      </div>
    </div>
  </div>
  ...
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__footer">
        <a href="/docs/architecture/overview" className="button button--primary button--block">View Architecture</a>
      </div>
    </div>
  </div>
</div>
...
<div className="row">
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__footer">
        <a href="/docs/components/overview" className="button button--primary button--block">Explore Components</a>
      </div>
    </div>
  </div>
  ...
  <div className="col col--6">
    <div className="card">
      ...
      <div className="card__footer">
        <a href="/docs/api-reference/overview" className="button button--primary button--block">Browse APIs</a>
      </div>
    </div>
  </div>
</div>
...
Wildbox is licensed under the **MIT License**. See [License](/docs/contributing/license) for details.

---

**Ready to get started?** Head over to the [Quick Start Guide](/docs/getting-started/quickstart) and have Wildbox running in 5 minutes!
