"""
Azure MONITOR Check: Diagnostic Settings
"""
...
class CheckDiagnosticSettings(BaseCheck):
    ...
    def get_metadata(self) -> CheckMetadata:
        return CheckMetadata(
            ...
            remediation="Implement diagnostic settings: "
    ...
    async def execute(self, session: Any, region: Optional[str] = None) -> List[CheckResult]:
        """Execute the diagnostic settings check."""
        results = []
        ...
        try:
            ...
            logger.error(f"Error in diagnostic settings check: {str(e)}")
            results.append(CheckResult(
                check_id=self.get_metadata().check_id,
