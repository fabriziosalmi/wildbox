"""
AZURE COSMOSDB Check: Cosmos DB Firewall
"""
...
class CheckCosmosDBFirewall(BaseCheck):
    ...
    def get_metadata(self) -> CheckMetadata:
        return CheckMetadata(
            ...
            remediation="Implement cosmos db firewall: "
    ...
    async def execute(self, session: Any, region: Optional[str] = None) -> List[CheckResult]:
        """Execute the cosmos db firewall check."""
        results = []
        ...
        try:
            ...
            logger.error(f"Error in cosmos db firewall check: {str(e)}")
            results.append(CheckResult(
                check_id=self.get_metadata().check_id,
