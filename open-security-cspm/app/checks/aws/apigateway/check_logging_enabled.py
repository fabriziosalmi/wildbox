"""
AWS APIGATEWAY Check: API Gateway Logging
"""
...
class CheckAPIGatewayLogging(BaseCheck):
    """Ensure API Gateway has logging enabled."""
    
    def get_metadata(self) -> CheckMetadata:
        return CheckMetadata(
            check_id="AWS_APIGATEWAY_001",
            ...
            remediation="Implement api gateway logging: "
                       "1. Go to AWS console. "
    ...
    async def execute(self, session: Any, region: Optional[str] = None) -> List[CheckResult]:
        """Execute the api gateway logging check."""
        results = []
        ...
        try:
            ...
            logger.error(f"Error in api gateway logging check: {str(e)}")
            results.append(CheckResult(
                check_id=self.get_metadata().check_id,
