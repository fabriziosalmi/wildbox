"""
AWS ECR Check: ECR Image Scanning
"""
...
class CheckECRImageScanning(BaseCheck):
    ...
    def get_metadata(self) -> CheckMetadata:
        return CheckMetadata(
            check_id="AWS_ECR_001",
            title="ECR Image Scanning",
            description="Ensure ECR repositories have image scanning enabled.",
            ...
            remediation="Implement ecr image scanning: "
    ...
    async def execute(self, session: Any, region: Optional[str] = None) -> List[CheckResult]:
        """Execute the ecr image scanning check."""
        results = []
        ...
        try:
            ...
            results.append(CheckResult(
                ...
                details={
                    ...
                    'service': 'ecr',
                    'check_type': 'ECR Image Scanning'
                }
            ))
                        
        except Exception as e:
            logger.error(f"Error in ecr image scanning check: {str(e)}")
            results.append(CheckResult(
                check_id=self.get_metadata().check_id,
